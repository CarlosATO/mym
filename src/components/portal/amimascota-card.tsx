    ...
    <section className="overflow-hidden rounded-2xl border border-theme-border/80 bg-theme-surface/80 shadow-sm">
      ...
      {error ? (
        ...
        <div className="grid grid-cols-1 divide-y divide-theme-border/70 sm:grid-cols-2 sm:divide-x sm:divide-y-0">
            <div className="min-w-0 px-4 py-2 sm:px-3">
            <p className="text-[10px] font-medium text-theme-text-muted/75">Ventas netas · mes actual</p>
            ...
            <div className="min-w-0 px-4 py-2 sm:px-3">
            <p className="text-[10px] font-medium text-theme-text-muted/75">Cobrado neto · mes actual</p>
            ...
            <div className="min-w-0 px-4 py-2 sm:px-3">
            <p className="text-[10px] font-medium text-theme-text-muted/75">Deuda no vencida · saldo actual</p>
            ...
            <div className="min-w-0 bg-amber-500/5 px-4 py-2 sm:px-3">
            <p className="text-[10px] font-medium text-amber-700/80 dark:text-amber-200/75">Deuda vencida · saldo actual</p>
