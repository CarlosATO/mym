...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  if (!permissionCodes.includes('module.adquisiciones.view') && !permissionCodes.includes('system.admin')) {
    return <AccessDenied />
  }
  ...
  return (
    <AdquisicionesLayoutClient profile={profileWithRole} permissions={permissionCodes}>
      {children}
