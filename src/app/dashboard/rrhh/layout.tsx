...
import { RrhhLayoutClient } from './rrhh-layout-client'
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  if (!permissionCodes.includes('rrhh.personal.view') && !permissionCodes.includes('system.admin')) return <AccessDenied />
  ...
  return <RrhhLayoutClient profile={profileWithRole} permissions={permissionCodes}>{children}</RrhhLayoutClient>
}
