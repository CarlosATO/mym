...
import { ComercialLayoutClient } from './comercial-layout-client'
...
export default async function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <ComercialLayoutClient profile={profileWithRole} permissions={permissionCodes}>
      {children}
    </ComercialLayoutClient>
  )
}
