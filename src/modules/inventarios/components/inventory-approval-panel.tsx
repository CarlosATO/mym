      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h3 className="flex items-center gap-2 text-sm font-semibold text-theme-text">
            <ShieldCheck className="h-4 w-4 text-theme-accent" /> Aprobación de la jornada
          </h3>
          <p className="mt-1 text-xs text-theme-text-muted">
            {ready
              ? 'La jornada está lista para aprobarse y generar el resultado oficial.'
      ...
      {confirming && (
        <div className="fixed inset-0 z-[1200] flex items-center justify-center bg-black/40 p-4">
          <div className="w-full max-w-md rounded-xl border border-theme-border bg-theme-surface p-5 shadow-2xl">
            <h3 className="text-base font-bold text-theme-text">Aprobar jornada</h3>
            <p className="mt-2 text-sm text-theme-text-muted">
              Se generará el <strong>resultado oficial</strong> de la jornada. Este paso no se puede deshacer.
            </p>
