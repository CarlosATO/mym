          ...
          {sessions.map(session => {
            ...
            return (
              <tr key={session.id} className="border-b border-theme-border/40 transition-colors hover:bg-theme-text/2">
                <td className="px-3 py-1.5 font-semibold text-theme-text">#{session.session_number}</td>
                <td className="max-w-[180px] truncate px-3 py-1.5 text-theme-text">{session.name}</td>
                ...
                <td className="px-3 py-1.5 text-theme-text-muted">
                ...
                <td className="px-3 py-1.5 text-right">
                  <Link
                    ...
                    aria-label={`Ver sección de conteo ${session.name}`}
