  ...
  return (
    <div ref={rootRef} className="shrink-0 border-b border-theme-border bg-theme-surface px-5 py-1.5">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <label className="flex shrink-0 cursor-pointer select-none items-center gap-1.5 text-xs font-medium text-theme-text">
          <input
            type="checkbox"
        ...
        <div className="flex shrink-0 items-center gap-0.5 rounded-md border border-theme-border bg-theme-bg/40 p-0.5" role="group" aria-label="Vista">
          {VIEWS.map(v => (
            <button
              key={v.id}
