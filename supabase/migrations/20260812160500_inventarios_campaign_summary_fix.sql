-- Corrección del contrato get_inventory_campaign_review_summary (V1).
--
-- Agrega el FROM computed c que faltaba en el SELECT de KPIs de stock del
-- resumen global (error PL/pgSQL al ejecutar la consulta).
--
