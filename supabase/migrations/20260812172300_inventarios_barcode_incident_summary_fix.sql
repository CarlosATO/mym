-- Corrección forward del resumen de incidencias de códigos (V1): el CTE agg
-- ahora se declara en el mismo statement del SELECT de items (no existía fuera
-- del SELECT del contador).
--
