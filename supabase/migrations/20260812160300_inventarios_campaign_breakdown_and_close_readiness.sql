-- Contratos Backend del Informe Global del Inventario (V1) — parte 2.
--
-- 3. get_inventory_campaign_product_breakdown(...)
--    Drill-down por producto: explica de dónde sale el physical_quantity
--    (contribuciones efectivas por sección/zona/ubicación/contador) + cabecera
--    de diferencias globales.
--
-- 4. get_inventory_campaign_close_readiness(...)
--    Check-list read-only de cierre administrativo global.
--
