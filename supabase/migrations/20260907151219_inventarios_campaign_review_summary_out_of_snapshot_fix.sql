-- ============================================================================
-- get_inventory_campaign_review_summary: corregir exclusivamente el join de
-- snapshot_coverage.
--
-- Problema: snapshot_products.snapshot_id referencia operational_snapshots.id
-- (clave FK company_id + id), pero el CTE usaba erróneamente
--   os.session_id = sp.snapshot_id
-- lo que inflaba out_of_snapshot (522 en vez de 58 para la campaña
-- 6ce60f09-0e66-4db5-b168-5fc7c013d4ea).
--
-- Corrección: relacionar snapshot_products.snapshot_id con operational_snapshots.id.
-- No se modifica nada más en esta función, ni ninguna otra función ni dato.
-- ============================================================================
