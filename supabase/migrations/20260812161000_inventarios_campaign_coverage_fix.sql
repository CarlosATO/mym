-- Corrección de cobertura en contratos del Informe Global del Inventario (V1).
--
-- Corrige el join de snapshot_coverage: snapshot_products.snapshot_id
-- referencia operational_snapshots.id (no session_id). Afecta a las 4 RPC.
--
