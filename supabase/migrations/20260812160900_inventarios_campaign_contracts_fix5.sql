-- Corrección definitiva de contratos del Informe Global del Inventario (V1).
--
-- Reemplaza list_inventory_campaign_variances y
-- get_inventory_campaign_review_summary con:
--   * coalesce sin prefijo pg_catalog (keyword SQL);
--   * casts numéricos explícitos en la valorización;
--   * FROM computed c en los SELECT de resumen.
--
