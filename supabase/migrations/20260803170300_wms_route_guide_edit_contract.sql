-- Migration: 20260803170300_wms_route_guide_edit_contract.sql
-- Description: Fase WMS-RG.1. Contrato transaccional de edicion de guias de
--              ruta no rendidas. SECURITY DEFINER, fail-closed por empresa,
--              diff de lineas, recalculado de totales y auditoria.
-- Author: Assistant
