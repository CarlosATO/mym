-- Migration: 20260803171200_wms_route_guide_edit_vresult_fix.sql
-- Description: Fase WMS-RG.1. Corrige v_result declarado como jsonb (recibe uuid
--              del RETURNING id) -> invalid input syntax for type json.
-- Author: Assistant
