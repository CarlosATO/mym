-- Restore the public PostgREST argument name without changing the read model.
...
BEGIN
    v_base := adquisiciones.get_route_settlement_detail_transfer_review_base(p_settlement_id);
    WITH clients AS (
