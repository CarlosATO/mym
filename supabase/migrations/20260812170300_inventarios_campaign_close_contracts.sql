-- Cierre Global del Inventario (V1) — Readiness y contratos del Informe con
-- fuente final congelada.
--
-- 1. get_inventory_campaign_close_readiness: agrega can_close_authorized
--    (SUPER_USUARIO OR ADMINISTRATOR activo), warnings/warning_count y
--    blockers/blocker_count.
--
-- 2. list_inventory_campaign_variances, get_inventory_campaign_review_summary,
--    get_inventory_campaign_product_breakdown: cuando campaign.status='APPROVED'
--    el físico global se consolida desde official_version_items de las sesiones
--    APPROVED (foto oficial congelada); en caso contrario usan la cadena
--    efectiva viva. get_inventory_campaign_export conserva la cadena efectiva
--    en su detalle (inmutable post-cierre porque Mobile queda bloqueado).
--
