-- A ZERO checkpoint starts confirmed duration at its own date, even when the
-- state before the rolling window is unknown.
...
BEGIN
    ...
    LOOP
        ...
        FOR point IN
            SELECT checkpoint_date, state, has_zero
