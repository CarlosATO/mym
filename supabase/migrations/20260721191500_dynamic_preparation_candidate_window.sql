-- Evita una fecha fija como umbral de candidatos: la ventana se calcula desde el corte activo.
...
BEGIN
  ...
  RETURN logistica.preview_next_route_candidates(p_company_id, v_min_generation_date);
END;
