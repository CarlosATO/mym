-- Migration: 20260803105030_inventarios_results_barcode_fix.sql
-- Description: Alinea alias x.barcode en get_inventory_session_results.
-- Author: Assistant
...
REVOKE ALL ON FUNCTION inventarios.get_inventory_session_results(uuid, uuid, text, text, integer, integer) FROM PUBLIC, anon, authenticated, service_role;
