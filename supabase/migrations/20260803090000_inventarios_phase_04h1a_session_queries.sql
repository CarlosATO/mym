-- Migration: 20260803090000_inventarios_phase_04h1a_session_queries.sql
-- Description: Fase 4H.1a. Contratos de consulta para UI web: listado paginado
--              de jornadas y detalle multi-estado. Sin acceso directo a tablas.
-- Author: Assistant

-- ============================================================
-- 1. RPC: list_inventory_sessions
--    Paginacion, filtros por status/bodega/fecha/texto, orden reciente,
--    cabecera y conteos resumidos, total de resultados.
-- ============================================================
...
-- ============================================================
-- 2. RPC: get_inventory_session_detail
--    Cabecera, snapshot, participantes, zonas/ubicaciones, tareas,
--    conteos resumidos, incidencias, recuentos, estado de aprobacion
--    o cancelacion. Coherente segun el estado.
-- ============================================================
