-- Migration: 20260805173000_inventarios_campaign_import_description_persistence.sql
-- Description: Persistencia de descripcion opcional en importaciones de campana y
--              lectura enriquecida con descripcion canonica de producto.
-- Author: Assistant
...
BEGIN
    ...
    SELECT CASE
        ...
        ELSE pg_catalog.jsonb_agg(
            pg_catalog.jsonb_build_object(
                ...
                'entered_description', r.entered_description,
                'product_id', r.product_id,
                'canonical_product_description', p.description,
    ...
    INTO v_rows
    FROM inventarios.stock_import_rows r
    LEFT JOIN adquisiciones.products p ON p.company_id = r.company_id AND p.id = r.product_id
    WHERE r.company_id = p_company_id AND r.import_id = p_import_id;
