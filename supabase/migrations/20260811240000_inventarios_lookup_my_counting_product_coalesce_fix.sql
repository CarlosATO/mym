-- =========================================================================================
-- MIGRATION: M1.5E.6 - Corregir coalesce interno de lookup_my_counting_product
-- =========================================================================================
-- COALESCE es un constructo SQL y no puede calificarse por esquema. La agregacion
-- final usaba pg_catalog.coalesce(...), que no existe como funcion y producia en
-- runtime: 42883 function pg_catalog.coalesce(jsonb, jsonb) does not exist.
-- Unico cambio funcional: pg_catalog.coalesce(...) -> coalesce(...).
