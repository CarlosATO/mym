-- =========================================================================================
-- MIGRATION: M1.5F fix2 - Recrea create_inventory_audit con chequeo explicito de
-- auditorias activas duplicadas (INV_AUDIT_PRODUCT_ALREADY_ASSIGNED) antes de
-- insertar, dejando el indice parcial unico como respaldo de concurrencia.
