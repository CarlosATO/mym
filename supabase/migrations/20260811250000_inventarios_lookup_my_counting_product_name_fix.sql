-- =========================================================================================
-- MIGRATION: M1.5E.7 - Corregir campo name de lookup_my_counting_product
-- =========================================================================================
-- El campo 'name' entregaba el SKU (p.ej. '43160') en vez de la descripcion legible,
-- porque el dedupe de candidates preferia source_rank=1 (snapshot_products.name), que
-- en este dataset es igual al SKU.
-- Unico cambio funcional: emitir 'name' desde master_matches (descripcion canonicca
-- integraciones.bsale_products.name / bsale_variants.description, ya calculada en la
-- propia RPC). Si no hay descripcion en maestra, 'name' es NULL (sin fallback a SKU).
