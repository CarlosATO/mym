-- Migration: 20260806121000_inventarios_counting_zone_assignment_fix.sql
-- Fase 4I.3C.7C.4B (correccion QA 1). Ajustes a las funciones de asignacion
-- de zonas publicadas en 20260806112000:
-- 1. tasks.validation_cycle debe ser > 0 por chk_inventarios_tasks_version:
--    la tarea PRIMARY inicial se crea con validation_cycle = 1 (no 0).
-- 2. La tarea cancelada conserva su status (la constraint
--    chk_inventarios_tasks_status no admite CANCELLED): el estado CANCELLED
--    queda representado por cancelled_at/cancelled_by + task_events, y el
--    envelope informa el status previo (patron de cancel_inventory_task).

-- ============================================================
-- 1. assign_inventory_counting_zone (corregida)
-- ============================================================
...
DECLARE
    ...
    v_participant_id uuid; v_zone_count bigint; v_zone_id uuid; v_zone_code text;
...
BEGIN
    ...
    v_zone_code := 'Z' || (v_zone_count + 1)::text;
    ...
    VALUES (p_company_id, p_session_id, v_snapshot_id,
        v_zone_code, v_zone_code, v_zone_name, v_zone_count::integer, true,
...
-- ============================================================
-- 3. OWNER, REVOKES Y GRANTS (replican los del schema original).
-- ============================================================
