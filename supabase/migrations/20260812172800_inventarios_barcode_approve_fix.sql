-- Corrección forward del approve de códigos (V1): el alias se inserta siempre
-- (incluso para productos no presentes en el snapshot de campaña, p.ej.
-- sobrantes), resolviendo product_id con fallback al snapshot de sesión.
--
