-- =========================================================================================
-- MIGRATION: M1.4A.1 - Mobile Zone Locations Operational State
-- =========================================================================================
...
BEGIN
    ...
    -- 4. Obtener ubicaciones y su estado operacional
    WITH locs AS (
        SELECT 
            sl.location_id,
            ...
            CASE WHEN tl.id IS NOT NULL THEN 'OPEN' ELSE NULL END AS location_status,
            tl.opened_at,
        ...
        LEFT JOIN inventarios.task_locations tl 
            ON tl.session_zone_location_id = szl.id 
