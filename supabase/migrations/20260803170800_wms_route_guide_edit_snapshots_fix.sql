-- Migration: 20260803170800_wms_route_guide_edit_snapshots_fix.sql
-- Description: Fase WMS-RG.1. Corrige nombres de columnas snapshot (route_name,
--              vehicle_name, person_name).
-- Author: Assistant
