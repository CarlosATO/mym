-- Migration: 20260803096000_inventarios_names_review.sql
-- Description: Fase 4H.2E. Resuelve nombres visibles de usuarios en
--              get_inventory_session_review (validadores, actores de incidencias
--              y recuentos).
-- Author: Assistant
