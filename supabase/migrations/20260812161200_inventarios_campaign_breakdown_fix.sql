-- Corrección de breakdown en contratos del Informe Global del Inventario (V1).
--
-- get_inventory_campaign_product_breakdown: para productos sin stock teórico
-- (sobrantes) inicializa theoretical_quantity=0 y resuelve sku/name por
-- bsale_variant_id desde snapshot_products (sin exigir product_id).
--
