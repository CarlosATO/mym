-- =========================================================================================
-- MIGRATION: M1.4A.3 - Hotfix: Response Envelope format for complete_idempotent_operation
-- =========================================================================================
...
BEGIN
    ...
    -- Construimos el payload siguiendo estrictamente el estándar esperado por complete_idempotent_operation
