...
- **Nota sobre Data Antigua (`d200`):** Existe data cargada bajo la compañía original PetGroup (`d2000000-0000-0000-0000-000000000002`). Esta data duplicada queda pendiente de limpieza futura y no genera impacto operativo en el entorno activo.
...
2. Definir si la limpieza de la compañía `d200` (PetGroup) se ejecutará mediante script directo o durante el cierre final de pruebas.
