...
4. **Protección de Datos Local**: Cualquier actualización extraída desde Bsale nunca borrará el campo de notas administrativas asignadas desde el panel local de PetGroup.
